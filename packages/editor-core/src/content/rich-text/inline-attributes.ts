...
export function sanitizeInlineAttrValue(value: unknown, contract: InlineAttributeContract): InlineAttributeJson {
  ...
  if (contract.sanitize === "string") {
    ...
    const stringValue = typeof value === "string" ? value : String(value ?? contract.default ?? "");
...
export function isInlineAttributePrimitive(value: InlineAttributeJson): value is InlineAttributePrimitive {
  return typeof value === "string" || typeof value === "number" || typeof value === "boolean" || value === null;
}

function sanitizeInlineJsonAttr(value: unknown, fallback: InlineAttributeJson): InlineAttributeJson {
