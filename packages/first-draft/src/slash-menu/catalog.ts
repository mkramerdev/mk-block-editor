...
export const firstDraftSlashActionCatalog: readonly FirstDraftSlashAction[] =
  Object.freeze([
    action("paragraph", "Text / Paragraph", "Text", ["text", "paragraph", "body"], {
      type: "paragraph",
    }),
    ...headings,
    action("bullet-list", "Bullet List", "Lists", ["bullet", "unordered", "list", "ul"], {
      type: "bulletList",
    }),
    action("numbered-list", "Numbered List", "Lists", ["numbered", "ordered", "list", "ol"], {
      type: "orderedList",
    }),
    action("checklist", "Checklist", "Lists", ["checklist", "todo", "task", "checkbox"], {
      type: "checklist",
    }),
    action("quote", "Quote", "Text", ["quote", "blockquote"], { type: "quote" }),
    action("code", "Code", "Text", ["code", "preformatted", "snippet"], { type: "code" }),
    action("callout", "Callout", "Text", ["callout", "note", "info"], { type: "callout" }),
    ...toggleHeadings,
    action("toggle-list", "Toggle List", "Toggles", ["toggle", "list", "collapse", "details"], {
      type: "toggleListItem",
    }),
    action("divider", "Divider", "Text", ["divider", "separator", "line", "hr"], { type: "divider" }),
    action("bookmark", "Bookmark", "Media", ["bookmark", "link", "url", "web"], { type: "bookmark" }),
    action("columns-2", "2 Columns", "Layout", ["columns", "column", "layout", "grid", "two"], {
      type: "columns",
      count: 2,
    }),
    action("columns-3", "3 Columns", "Layout", ["columns", "column", "layout", "grid", "three"], {
      type: "columns",
      count: 3,
    }),
    action("columns-4", "4 Columns", "Layout", ["columns", "column", "layout", "grid", "four"], {
      type: "columns",
      count: 4,
    }),
    action("tabs", "Tabs", "Layout", ["tabs", "tab", "panes"], { type: "tabs" }),
    action("table", "Table", "Layout", ["table", "grid", "rows", "columns"], { type: "table" }),
  ]);
